...
console.log(
  "🔧 Setting up environment variables for 1inch Cross-Chain Swap API...\n"
);
...
console.log("4. PORT - Server port (default: 3001)");
console.log("5. NODE_ENV - Environment (development/production)");
console.log("6. FRONTEND_URL - Frontend domain for CORS (production only)");
...
console.log("- In production, set NODE_ENV=production and FRONTEND_URL");

console.log("\n🚀 After setting up your .env file, run:");
console.log("npm install");
console.log("npm run build:start  # For production");
